...
export default function Navbar() {
  ...
  // Adjust body padding to navbar height
  useEffect(() => {
  ...
  const handleNavigation = (path) => {
    setMenuOpen(false);
    navigate(path);
    // scroll is already handled by the useEffect above
  };
  ...
  const getHorizontalPadding = () => {
    if (isMobile) return isExtraSmall ? "0 16px" : "0 32px";
    return "0 60px";
  };
  ...
  const logoImgStyle = {
    height: isMobile ? (isExtraSmall ? "40px" : "50px") : "60px",
    width: "auto",
    objectFit: "cover",
    borderRadius: "12px",
    transition: "transform 0.2s ease",
  ...
  const logoNameStyle = {
    fontSize: isMobile ? (isExtraSmall ? "18px" : "22px") : "28px",
    fontWeight: 800,
    color: "#0f172a",
    lineHeight: 1.2,
    letterSpacing: "-0.5px",
  ...
  const logoSubStyle = {
    fontSize: isMobile ? (isExtraSmall ? "9px" : "11px") : "13px",
    fontWeight: 700,
    color: "#2563eb",
  ...
  const labReportButtonStyle = {
    ...buttonBaseStyle,
    display: isExtraSmall ? "none" : "inline-flex",
    ...
    <>
      ...
      <nav ref={navbarRef} style={navbarStyle}>
        <div style={navbarContainerStyle}>
          <div style={topRowStyle}>
            {/* Logo - now links to home page only */}
            <Link
              to="/"
              style={logoStyle}
            ...
            {/* Desktop center group */}
            {!isMobile && (
              <div style={centerGroupStyle}>
                {/* Location button - redirects to admin login */}
                <div
      ...
      <div style={mobileMenuStyle}>
        <div style={mobileInfoSectionStyle}>
          {/* Mobile location button - redirects to admin login */}
          <div
