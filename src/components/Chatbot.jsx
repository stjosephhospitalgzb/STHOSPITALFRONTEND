...
const Chatbot = () => {
  ...
  const showContactInfo = () => {
    const contactHtml = `
      <div>
        <p>📞 <strong>St. Joseph's Hospital – Contact Information</strong></p>
